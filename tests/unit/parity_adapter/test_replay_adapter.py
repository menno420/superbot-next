...
def test_full_corpus_reconstructs():
    """Every golden on disk yields a replayable case (477/477) — curated
    ...
    cases + the 2 minted multi-step tournament-flow cases + the 1 minted
    paid-tournament conservation case
