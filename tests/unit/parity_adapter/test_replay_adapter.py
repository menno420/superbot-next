...
def test_full_corpus_reconstructs():
    """Every golden on disk yields a replayable case (478/478) — curated
    ...
    cases + the 2 minted multi-step tournament-flow cases
    + the 2 D-0081 creature picker/bot-guard cases
