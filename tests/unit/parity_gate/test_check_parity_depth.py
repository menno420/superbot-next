...
class TestImportedCorpus:
    def test_corpus_golden_count(self):
        ...
        # (2026-07-12) + 2 minted multi-step tournament-flow goldens + 1 minted
        # paid-tournament conservation golden (2026-07-12) (parity.yml
    ...
    def test_source_pin_recorded(self):
        ...
        # + 2 multi-step tournament-flow mints + 1 paid-tournament
        # conservation mint (2026-07-12)
        assert source["minted_goldens"] == 15
