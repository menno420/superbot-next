...
class TestImportedCorpus:
    def test_corpus_golden_count(self):
        ...
        # (D-0073) + 4 minted kernel-band goldens (D-0075) + 4 minted
        # browse-interaction goldens (2026-07-12; parity.yml
    ...
    def test_source_pin_recorded(self):
        ...
        # 2 D-0073 modal-submit mints + 4 D-0075 kernel-band mints + 4
        # browse-interaction mints (2026-07-12)
        assert source["minted_goldens"] == 10
