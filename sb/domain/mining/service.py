...
vault, workshop repair/quickcraft, the energy-lane cook/use
consumables, and the slice-3 fastmine dig energy spend), and honest
pending terminals for what still rides named successor work (wear
ticks, grid dig, structure builds, skill spends — the D-0043 tail).
