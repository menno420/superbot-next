...
PENDING: dict[str, str] = {
    ...
    # "nothing broken" pure read). The structures BUILD write (🔥 Build / 🏠
    # Build) is LIVE as of WP-6 (forge_build_route / home_build_route); the argful
    # cook/use energy lanes stay deferred (D-0043 pending terminals).
