...
slice-2 rod ladder and the bait shop (coordinated fill) are live;
craft/structure surfaces are honest pending terminals riding the
D-0043 named successor port."""
...
_COMMANDS = (
    ...
    # --- the bait shop (coordinated bait fill — LIVE) ----------------------
