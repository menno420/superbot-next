...
are shipped-surface render drift (D-0025/D-0026/D-0027 successor work) — see D-0050.
```
...
7. **Band-1 golden corpus vs successor-work boundary**: the 53 band-1
   ...
   slices in D-0025/D-0026/D-0027. Until those slices port, band-1 parity
