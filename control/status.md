...
- superbot #2110 (ORDERs 003+005 docs, claude/order-005-supersede-stubs @ 5f5e1bb): all required checks green, awaiting enabler auto-land; advisory request-codex-review red (GitHub rate limit) is non-blocking.
...
## NEXT
1. Verify superbot #2110 auto-lands (ORDERs 003+005 done-truth recording stays hub-venue).
2. Session ender: flip the #490 card (auto-merge then lands the heartbeat).
