...
## ⚑ NEEDS-OWNER
1. superbot ORDERs 003+005 landing: docs-only patch (+61/−9) staged CI-green in the dispatched session; autonomous push to the prod repo classifier-denied (verbatim in docs/CAPABILITIES.md 2026-07-15 + PR #490 body). Unblock: one owner message "land it" in that session; then the enabler lands it on green. RISK ✅ docs-only.
2. D-0043 deep-game go/no-go (restored — rotated out at the 2026-07-14 dormancy): draining the 25 mining + 15 fishing unmapped goldens turns on the deep-game ports (docs/decisions.md:326; docs/review/program-review-2026-07-12.md:590-598). Owner-gated.
...
2. superbot hub upkeep: ORDERs 003+005 staged in the dispatched session, awaiting the owner turn (⚑1); hub heartbeat re-stamp stays hub-venue.
