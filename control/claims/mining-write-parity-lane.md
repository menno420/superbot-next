...
- `wp1-equip-loadout-writegoldens` · **write-parity WP-1 — equip/unequip/loadout save·apply·delete write goldens [PLANNED — awaits owner go]** — mint argful-capture goldens driving `mining.record_equip/unequip/save_loadout/apply_loadout/delete_loadout`; retire `depth.exemptions.mining` `table:mining_equipment` + `table:mining_loadout_presets` + ratchet bump · area: parity/cases/, parity/goldens/mining/, parity/parity.yml · 2026-07-12T21:33:48Z
