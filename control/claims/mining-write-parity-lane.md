...
- `wp2-vault-writegoldens` · **write-parity WP-2 — stash/unstash/stash-all/vaultupgrade write goldens [IN FLIGHT — stacked on #306]** — funded-fixture argful goldens driving `mining.record_stash/unstash/stash_all/vault_upgrade`; retire `table:mining_vault` + `table:mining_player_state` (vault_level share) + ratchet; adds a two-txn vault_upgrade advisory-lock concurrency regression test · area: parity/cases/, parity/goldens/mining/, parity/parity.yml, tests/integration/ · 2026-07-12T21:33:48Z
