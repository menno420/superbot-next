...
> tables. **WP-7 (below, DELIVERED — PR #371)** is a coverage-deepening follow-on:
> it ports the residual non-energy pending WRITE legs (respec / craft) that the
